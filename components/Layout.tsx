...
import { Home, Users, CreditCard, Calculator, LogOut, Menu, X, FileText, Bell, AlertTriangle, Wallet, Calendar, Vote, Settings, Check, Loader2, Box, PieChart, MessageSquare, Wifi, WifiOff, Handshake, BarChart3, Target } from 'lucide-react';
...
export const Layout: React.FC<LayoutProps> = ({ children, activeTab, setActiveTab, onLogout, overdueMembers, saveStatus, user, isOnline }) => {
  ...
  const menuItems = [
    ...
    { id: 'negotiations', label: 'Negociação', icon: Handshake, roles: ['FOX_ADM', 'TESOUREIRO', 'PRESIDENTE'], color: 'text-pink-500', tooltip: 'Criação e acompanhamento de acordos de dívidas.' },
    ...
    { id: 'budgets', label: 'Orçamentos', icon: Target, roles: ['FOX_ADM', 'TESOUREIRO'], tooltip: 'Planejamento e controle de metas de gastos por categoria.' },
